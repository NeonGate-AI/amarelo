...
import { CaretLineDownIcon, MagnifyingGlassIcon } from '@phosphor-icons/react'
...
export function FaqSearchable(props: FaqSearchableProps) {
  const {
    ...
    <section className="py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          <MagnifyingGlassIcon
            size={20}
            className="absolute top-1/2 left-4 -translate-y-1/2 text-foreground/40"
          />
          <input
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      onClick={() => handleAccordionToggle(originalIndex)}
                      type="button"
                    >
