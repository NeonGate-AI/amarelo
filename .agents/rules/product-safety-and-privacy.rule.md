---
title: Product safety and privacy rules
scope: product behavior, data, prompts, UI, tools, and product agents
authority: owner-aligned non-negotiable policy
---

# Product safety and privacy rules

- Keep the person in control of retention, correction, use, and sharing.
- Never present Amarelo as therapy, diagnosis, treatment, medication authority, crisis service, or a replacement for qualified care.
- Do not probe for a hidden root cause, foundational trauma, or “central issue”. Clarification is limited to meaning, chronology, correction, consent, and representation.
- Keep raw audio, transcript, conversation, journal, memory, summary, inference, profile, and shared representation structurally distinct.
- Preserve provenance and uncertainty through every transformation. Never present model inference as a direct report or clinical fact.
- Keep private data private by default. Authenticate and authorize before retrieval, not after private context has entered model input.
- Minimize retrieval and disclosure by purpose, recipient, category, and time window.
- Sharing must be explicit, granular, inspectable, revocable, and auditable. A relationship never implies access.
...
- Use synthetic data for examples and future verification. Never encode a real person's private history in repository artifacts.
