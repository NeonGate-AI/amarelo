---
id: ADR-0036
title: Enforce Memory eligibility and integrity before ranking
status: accepted
date: 2026-09-04
deciders:
  - product-owner
...
# ADR-0036: Enforce Memory eligibility and integrity before ranking

## Status

Accepted on 2026-09-04.

Identity repaired by SPEC-046 from the collided ADR-0030 to ADR-0036. This is a catalog correction, not a new decision or supersession of the Chatterbox boundary.
