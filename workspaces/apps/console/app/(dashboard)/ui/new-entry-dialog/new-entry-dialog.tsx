...
import { Dialog } from '@repo/react/vendors/shadcn/dialog'
    ...
    >
      {saved ? (
        <output className="flex min-h-64 flex-col items-center justify-center text-center">
          ...
          <h3 className="mt-4 text-xl font-bold">Registro de exemplo salvo</h3>
          <Button
            className="mt-5"
        ...
        <form className="grid gap-5" onSubmit={handleSubmit}>
          ...
          >
            ...
            <select
              ...
              name="elo"
            >
              <option value="none">Sem Elo relacionado</option>
              <option value="ana">Ana · neurodivergência</option>
              <option value="nico">Nico · depressão e ansiedade</option>
              <option value="isa">Isa · relacionamentos</option>
            </select>
          </label>
