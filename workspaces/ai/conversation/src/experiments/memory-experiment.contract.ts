...
export const MemoryExperimentPolicySchema = z.object({
...
export type MemoryExperimentPolicy = z.infer<typeof MemoryExperimentPolicySchema>

/** References are accepted only through the injected server-owned artifact verifier. */
export const MemoryExperimentGateReferenceSchema = z.object({
...
export type MemoryExperimentGateReference = z.infer<typeof MemoryExperimentGateReferenceSchema>
export const MemoryExperimentEvidenceSchema = z.object({
...
export const MemoryExperimentMetricsSchema = z.object({
...
export type MemoryExperimentMetrics = z.infer<typeof MemoryExperimentMetricsSchema>
